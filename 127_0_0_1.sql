...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 14 2021 г., 22:51
...
--
CREATE DATABASE IF NOT EXISTS `billiard_room_statistics` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_estonian_ci;
USE `billiard_room_statistics`;
...
INSERT INTO `main_info` (`id`, `orderdate`, `ordertime`, `tablenumber`) VALUES
(1, '0000-00-00', '00:00:00.000000', 1),
(2, '0000-00-00', '00:00:06.000000', 1);
...
--
ALTER TABLE `money`
  ADD CONSTRAINT `money_ibfk_1` FOREIGN KEY (`id`) REFERENCES `main_info` (`id`);
--
...
('root', '[{\"db\":\"billiard_room_statistics\",\"table\":\"main_info\"},{\"db\":\"billiard_room_statistics\",\"table\":\"main info\"},{\"db\":\"billiard_room_statistics\",\"table\":\"money\"},{\"db\":\"billiard_room_statistics\",\"table\":\"main _info\"},{\"db\":\"billiard room statistics\",\"table\":\"main info\"},{\"db\":\"billiard room statistics\",\"table\":\"money\"}]');
...
('root', '2021-06-14 20:50:29', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ru\"}');
